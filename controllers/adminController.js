...
module.exports = {
    ...
    getEditCommentsPage: async (req, res) => {
        ...
        Comment.findById(commentId).then(comment => {
            ...
            res.render('admin/comments/edit', {comment: comment, comments: comments});
    ...
    deleteComment: (req, res) => {
        ...
        let c = Comment.find(req.params.id).populate('user').populate('category');
        ...
        Comment.findByIdAndDelete(req.params.id)
                .then(deletedComment => {
                    console.log(deletedComment.user);
                    req.flash('success-message', `The comment ${deletedComment.body} ${deletedComment.user} has been deleted.`);
